...
class MyCircleColorPicker extends StatefulWidget {
  const MyCircleColorPicker({
    Key key,
    this.onChanged,
  ...
  @override
  _MyCircleColorPickerState createState() => _MyCircleColorPickerState();
}

class _MyCircleColorPickerState extends State<MyCircleColorPicker>
      ...
      child: Stack(
        children: <Widget>[
          _HuePicker(
            ...
            onPanEndDone: widget.onPanEndDone,
            onChanged: (hue) {
